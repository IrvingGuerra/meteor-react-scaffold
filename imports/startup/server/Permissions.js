...
const Permissions = {
	...
	GENDERS: {
		LIST: { VALUE: 'genders-view', TEXT: 'Listar generos' },
		CREATE: { VALUE: 'genders-create', TEXT: 'Crear genero' },
		UPDATE: { VALUE: 'genders-edit', TEXT: 'Actualizar genero' },
		DELETE: { VALUE: 'genders-delete', TEXT: 'Eliminar genero' }
	}
}
